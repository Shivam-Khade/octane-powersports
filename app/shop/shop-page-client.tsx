    ...
    <main className="shop-premium-bg">
      ...
      <section className="container mt-12 mb-20">
        <div className="bg-[#111] rounded-2xl p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-6 border border-gray-800 shadow-2xl relative overflow-hidden">
          ...
          <a href="https://wa.me/910000000000?text=Hi,%20I'm%20looking%20for%20a%20specific%20part..." target="_blank" rel="noopener noreferrer" className="z-10 shrink-0 bg-[#25D366] hover:bg-[#128C7E] !text-white px-4 py-3 md:px-8 md:py-4 text-sm md:text-base rounded-full font-bold uppercase tracking-wide flex items-center justify-center gap-2 md:gap-3 transition-colors shadow-[0_0_20px_rgba(37,211,102,0.3)] hover:shadow-[0_0_30px_rgba(37,211,102,0.5)] w-full md:w-auto">
